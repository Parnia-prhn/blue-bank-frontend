...
export default function LoanApp() {
  ...
  return (
    <div dir="rtl" className="flex flex-col justify-center bg-emerald-50 ">
      ...
      <div className="text-black">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 ">
          <div className="flex flex-col">
            <FaUser className=" w-24 h-24 bg-emerald-200 rounded-full m-5 text-emerald-500 place-self-center p-5" />
          ...
          <div className="flex flex-col">
            <IoSpeedometer className="w-24 h-24 p-5 bg-emerald-200 rounded-full m-5 text-emerald-500 place-self-center" />
          ...
          <div className="flex flex-col">
            <GiSwapBag className="w-24 h-24 p-5 bg-emerald-200 rounded-full m-5 text-emerald-500 place-self-center" />
      ...
      <TbKeyframeAlignHorizontalFilled className="m-2 text-center text-purple-600 size-8 place-self-center" />
      <h1 className="text-right font-bold text-lg m-3 text-black">
        رفتار مالی در بلو؟
      </h1>
      <p className="text-right m-2 mb-7 text-black">
      ...
      <div className="flex justify-center place-self-center text-black rounded-lg">
      ...
      <h1 className="text-right font-bold text-xl text-black m-2">
      ...
      <TbKeyframeAlignHorizontalFilled className="m-2 text-center text-purple-600 size-8 place-self-center" />
      <h1 className="text-right font-bold m-3 text-black">وام شرکای تجاری</h1>
      <p className="text-right m-2 text-black">
      ...
      <TbKeyframeAlignHorizontalFilled className="m-2 text-center text-purple-600 size-8 place-self-center" />
      <h1 className="m-8 font-bold text-right text-black">وام سازمانی</h1>
      <p className="text-right m-3 text-black">
      ...
      <div className="bg-white w-full place-self-center text-center text-black mt-5 p-7">
