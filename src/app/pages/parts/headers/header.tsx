...
export default function Header({ bg }: HeaderProps) {
	...
	return (
		<div className="w-full h-auto" style={{ backgroundColor }}>
					...
					<ul className="pt-0 mt-0 flex flex-row-reverse ">
						<li className="p-3 border-transparent hover:border-4 hover:border-t-blue-800 ">
							<Link href="/">
								...
								{bg === "white" && <Button type="link">خانه</Button>}
							</Link>
						</li>
						<li className="p-3 border-transparent hover:border-4 hover:border-t-blue-800">
							{bg === "transparent" && (
						...
						<li>
							<div>
								<Button type="primary" className="p-5 m-6">
									باز کردن حساب بلو
								</Button>
							</div>
						</li>
