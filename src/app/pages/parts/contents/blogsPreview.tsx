...
export default function BlogsPreview() {
  return (
    <div>
      <div
        dir="rtl"
        className="flex flex-row justify-center flex-wrap m-14 p-14"
      >
        {blogs.map((blog) => (
          <Card
            key={blog.id}
            className="bg-blue-100 m-2 rounded-md shadow-xl border-transparent text-right"
            hoverable
            style={{ width: 450, height: "fit-content" }}
            cover={<img width="100%" height="auto" src={blog.imagePreview} />}
          >
            <p>
              <b className="flex justify-end">{blog.name}</b>
            </p>
