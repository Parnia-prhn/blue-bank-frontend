  ...
  return (
    <div className="bg-white m-3 p-3">
      <div className="grid grid-cols-4">
        <div className="col-end-5 flex flex-col">
        ...
        <div className="col-start-2 flex flex-col m-3 p-3">
        ...
        <div className="col-start-1 flex flex-col m-3 p-3">
          <a href="" className="p-3 m-3">
            <img src={sibapp} />
          </a>
          <a href="" className="p-3 m-3">
        ...
        <div className="flex flex-row">
          <div className="col-start-1 col-span-2 m-3 p-3">
            <a href="" className="m-3 p-3">
              <img src={logoblue} />
            </a>
            <p>Copyright © 2024 bluBank Saman. All rights reserved</p>
          </div>
          <div className="col-end-5 flex flex-row m-3 p-3">
            <Button
              shape="circle"
              className="m-3 p-3"
              icon={<IoShareSocial />}
